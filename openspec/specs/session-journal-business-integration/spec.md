# session-journal-business-integration Specification

## Purpose
TBD - created by archiving change add-session-journal-business-integration. Update Purpose after archive.
## Requirements
