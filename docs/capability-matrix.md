...
| **Retry + error classification** | Exponential backoff, server hint delays, 12 error classes, and machine-readable recovery plans | `retry_async` / `LLMError` / `RecoveryPlan` | — | [llm-client.md](architecture/llm-client.md) | — |
